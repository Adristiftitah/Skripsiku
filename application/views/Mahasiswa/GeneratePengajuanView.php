...
<table class="table table-striped table-hover" style="width:125%;">
    <tbody>
        <tr>
            <td>Nama Kegiatan</td>
            <td>:</td>
            <td>Peraktek Kerja Lapangan</td>
        </tr>
        <tr>
            <td>Tempat</td>
            <td>:</td>
        ...
        <tr>
            <td>Pelaksanaan</td>
            <td>:</td>
            <td>atau sesuai dengan kebijakan instansi asalkan 
...
<p style="text-align: center;"> Malang, 10 Juni 2022 <br>Mengetahui dan Menyetujui,</p>
