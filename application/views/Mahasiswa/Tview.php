    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                    if (isset($tampilan_mahasiswa)) {
                        $this->load->view($tampilan_mahasiswa);
                    }
                ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/MahasiswaController/logout">Logout</a>
                </div>
            </div>
        </div>
    </div>
